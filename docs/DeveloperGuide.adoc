...
_Figure 3.6.3 : UI button added to the `MainWindow`_
...
_Figure 3.7.1 : Sequence diagram of `sort` command_
...
----
image::LocationWebsiteUI.png[width="800"]
_Figure 3.6.3 : Singapore Botanic Gardens' website_
// end::goto[]
---
//tag::findCommand[]
