...
**Cons:** Tags are randomly ordered, bookmark tag position is not consistent in the person list.  +
**Alternative 2:** Create a new class and have it as a new attribute in `Person` +
**Pros:** Able to have fixed positioning of bookmark when listing persons. +
...
**Cons:** Only 1 bookmark "list" for user to put their favourite persons. +
**Alternative 2:** A more general command for user to change tags of specific person +
...
|`*` |user |the person in charge of the places |contact when necessary
...
[discrete]
=== Use case: Example Delete person
