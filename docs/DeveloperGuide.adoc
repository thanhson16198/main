...
_Figure 3.4.1 : Structure of the UI Component with MRTWindow_
...
_Figure 3.4.2 : Structure of the UI Component with MRTWindow_
...
_Figure 3.4.3 : UI button added to the `MainWindow`.
