...
Edits the phone number and email address of the 1st place to be `91234567` and `johndoe@example.com` respectively.
* `edit 2 n/Betsy Crower t/` +
Edits the name of the 2nd place to be `Betsy Crower` and clears all existing tags.

=== Locating places by name: `find`
...
* Places matching at least one keyword will be returned (i.e. `OR` search). e.g. `Hans Bo` will return `Hans Gruber`, `Bo Yang`
****
...
* `find Betsy Tim John` +
Returns any place having names `Betsy`, `Tim`, or `John`
