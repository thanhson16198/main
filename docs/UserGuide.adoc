...
Format: `ed INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [t/TAG]...`
...
* `ed 2 n/Betsy Crower t/` +
Edits the name of the 2nd person to be `Betsy Crower` and clears all existing tags.

=== Locating persons by name: `find` or  `fd`
...
Removes the specified tag from all persons in the address book. +
Format: `remove_tag TAG_NAME`

****
* Removes specified tag from address book
...
* `remove_tag friends` +
friends will be removed from addressbook

* `remove_tag banker lawyer` +
only banker tag will be removed, lawyer tag is ignored

=== Selecting a person : `select` or `se`
...
=== MRT map of Singapore: `map`

Display the latest MRT map of Singapore by clicking on "MRT map" button or typing command `map`
...
or `a n/James Ho p/22224444 e/jamesho@example.com a/123, Clementi Rd, 1234665`
* *Clear* : `clear` or `c`
* *Delete* : `delete INDEX`  or `del INDEX` +
e.g. `delete 3`
* *Edit* : `edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [t/TAG]...` +
e.g. `edit 2 n/James Lee e/jameslee@example.com` or ``ed 2 n/James Lee e/jameslee@example.com`
