...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_PHONE_DESC + WEBSITE_DESC_AMY, Phone.MESSAGE_PHONE_CONSTRAINTS);
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_WEBSITE_DESC + VALID_ADDRESS_AMY + VALID_PHONE_AMY,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + WEBSITE_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;

        EditCommand.EditPlaceDescriptor descriptor = new EditPlaceDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withWebsite(VALID_WEBSITE_AMY).withAddress(VALID_ADDRESS_AMY)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + WEBSITE_DESC_AMY;

        EditCommand.EditPlaceDescriptor descriptor = new EditPlaceDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        EditCommand.EditPlaceDescriptor descriptor = new EditPlaceDescriptorBuilder().withName(VALID_NAME_AMY).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // phone
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY;
        descriptor = new EditPlaceDescriptorBuilder().withPhone(VALID_PHONE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // email
        userInput = targetIndex.getOneBased() + WEBSITE_DESC_AMY;
        descriptor = new EditPlaceDescriptorBuilder().withWebsite(VALID_WEBSITE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_PLACE;
        String userInput = targetIndex.getOneBased()  + PHONE_DESC_AMY + ADDRESS_DESC_AMY + WEBSITE_DESC_AMY
                + TAG_DESC_FRIEND + PHONE_DESC_AMY + ADDRESS_DESC_AMY + WEBSITE_DESC_AMY + TAG_DESC_FRIEND
                + PHONE_DESC_BOB + ADDRESS_DESC_BOB + WEBSITE_DESC_BOB + TAG_DESC_HUSBAND;

        EditCommand.EditPlaceDescriptor descriptor = new EditPlaceDescriptorBuilder().withPhone(VALID_PHONE_BOB)
                .withWebsite(VALID_WEBSITE_BOB).withAddress(VALID_ADDRESS_BOB).withTags(VALID_TAG_FRIEND,
                        VALID_TAG_HUSBAND)
                .build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + WEBSITE_DESC_BOB + INVALID_PHONE_DESC + ADDRESS_DESC_BOB
                + PHONE_DESC_BOB;
        descriptor = new EditPlaceDescriptorBuilder().withPhone(VALID_PHONE_BOB).withWebsite(VALID_WEBSITE_BOB)
    ...
    public void parse_resetTags_success() {
        ...
        EditCommand.EditPlaceDescriptor descriptor = new EditPlaceDescriptorBuilder().withTags().build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
