...
public class UndoCommandTest {
    ...
    private final DeleteCommand deleteCommandOne = new DeleteCommand(INDEX_FIRST_PLACE);
    private final DeleteCommand deleteCommandTwo = new DeleteCommand(INDEX_FIRST_PLACE);
