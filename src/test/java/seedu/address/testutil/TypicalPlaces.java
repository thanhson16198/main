...
public class TypicalPlaces {
    ...
    public static final ReadOnlyPlace ALICE = new PlaceBuilder().withName("Alice Pauline")
            .withAddress("123, Jurong West Ave 6, #08-111").withPostalCode("111111").withEmail("alice@example.com")
            .withPhone("85355255")
    ...
    public static final ReadOnlyPlace CARL = new PlaceBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street").withPostalCode("111111").build();
    public static final ReadOnlyPlace DANIEL = new PlaceBuilder().withName("Daniel Meier").withPhone("87652533")
            .withEmail("cornelia@example.com").withAddress("10th street").withPostalCode("111111").build();
    public static final ReadOnlyPlace ELLE = new PlaceBuilder().withName("Elle Meyer").withPhone("9482224")
            .withEmail("werner@example.com").withAddress("michegan ave").withPostalCode("111111").build();
    public static final ReadOnlyPlace FIONA = new PlaceBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withEmail("lydia@example.com").withAddress("little tokyo").withPostalCode("111111").build();
    public static final ReadOnlyPlace GEORGE = new PlaceBuilder().withName("George Best").withPhone("9482442")
            .withEmail("anna@example.com").withAddress("4th street").withPostalCode("111111").build();

    // Manually added
    public static final ReadOnlyPlace HOON = new PlaceBuilder().withName("Hoon Meier").withPhone("8482424")
            .withEmail("stefan@example.com").withAddress("little india").withPostalCode("111111").build();
    public static final ReadOnlyPlace IDA = new PlaceBuilder().withName("Ida Mueller").withPhone("8482131")
            .withEmail("hans@example.com").withAddress("chicago ave").withPostalCode("111111").build();

    // Manually added - Place's details found in {@code CommandTestUtil}
    public static final ReadOnlyPlace AMY = new PlaceBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withPostalCode(VALID_POSTAL_CODE_AMY).withTags
                    (VALID_TAG_FRIEND).build();
    public static final ReadOnlyPlace BOB = new PlaceBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withPostalCode(VALID_POSTAL_CODE_BOB).withTags
