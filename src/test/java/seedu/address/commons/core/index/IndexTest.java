...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthPlaceIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthPlaceIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthPlaceIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthPlaceIndex.equals(fifthPlaceIndex));

        // null -> returns false
        assertFalse(fifthPlaceIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthPlaceIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthPlaceIndex.equals(Index.fromOneBased(1)));
    }
}
