...
public class Messages {
    ...
    public static final String MESSAGE_BOOKMARKS_SHOWN = "Showing all bookmarks";
    public static final String MESSAGE_INVALID_INDEX = "The place index provided is invalid";
